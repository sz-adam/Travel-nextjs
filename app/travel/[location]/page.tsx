...
const TravelDetails = ({ params }: CardProps) => {
  ...
  return (
    ...
    >
      <div className="h-5/6 w-5/6 md:h-2/3 md:w-2/3 bg-gray-500 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100 overflow-auto">
